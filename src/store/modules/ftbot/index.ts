    ...
    return {
        ...
        getters: {
            [BotStoreGetters.botName](state: FtbotStateType) {
                return state.botState?.bot_name || 'kitobor';
            },
        ...
        actions: {
            ...
            async [BotStoreActions.getStrategyPlotConfig]({commit}) {
                try {
                    ...
                    if (plotConfig.subplots === null) {
                        ...
                        // TODO: Remove this fix when fix in kitobor is populated further.
                        plotConfig.subplots = {};
                    }
            ...
            async [BotStoreActions.forcebuy]({dispatch}, payload: ForcebuyPayload) {
                if (payload && payload.pair) {
                    try {
                        const res = await api.post<ForcebuyPayload,
                            AxiosResponse<StatusResponse | TradeResponse>>('/forcebuy', payload);
